...
export default function MobileApp() {
  ...
  const features = [
    ...
    { icon: <Bell className="text-cyan-500" />, title: "Study Planner", description: "Intelligent scheduling that adapts to your learning pace and upcoming exams." },
    { icon: <Smartphone className="text-cyan-500" />, title: "Native Experience", description: "Haptic feedback and gesture-based navigation for a seamless touch interface." },
    { icon: <Zap className="text-cyan-500" />, title: "Low Latency", description: "Edge computing ensures responses are delivered in under 200ms anywhere in the world." },
    { icon: <ShieldCheck className="text-cyan-500" />, title: "Secure Data", description: "End-to-end encryption for all your study notes and private conversations." },
    { icon: <Cpu className="text-cyan-500" />, title: "Edge Processing", description: "Runs heavy AI models locally on your device to ensure privacy and speed." },
    { icon: <Globe className="text-cyan-500" />, title: "Global Sync", description: "Seamlessly synchronize your progress across all your devices and platforms." }
  ];
      ...
      <div className="relative z-10 p-8 h-screen overflow-y-auto scrollbar-hide">
        <div className="max-w-6xl mx-auto space-y-16 py-20">
          <div className="space-y-6 text-center max-w-3xl mx-auto">
            <div className="inline-block px-4 py-1 rounded-full border border-cyan-500/30 bg-cyan-500/5 text-[10px] uppercase tracking-widest text-cyan-500 mb-4">Version 2.0 Now Available</div>
            <h1 className="text-6xl md:text-8xl font-bold tracking-tighter leading-tight">MEDILERN <span className="text-cyan-500">MOBILE</span></h1>
            <p className="text-xl text-neutral-400 font-light leading-relaxed">The most powerful medical AI assistant ever built for mobile, designed for students and professionals who need precision on the go.</p>
          </div>
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between border-b border-white/5 pb-2">
                  ...
                  <span className="text-neutral-300">Minimum 250MB free space</span>
                </div>
                <div className="flex justify-between border-b border-white/5 pb-2">
                  <span className="text-neutral-500">RAM</span>
                  <span className="text-neutral-300">Recommended 4GB+</span>
                </div>
              </div>
            </div>
